...
// session_start();
// $tinybrowser['sessioncheck'] = 'User'; //name of session variable to check

// Random string used to secure Flash upload if session control not enabled - be sure to change!
$tinybrowser['obfuscate'] = 's0sdfdmerand0mjunk!!!111';
...
$tinybrowser['docroot'] = rtrim($_SERVER['DOCUMENT_ROOT'].'/app/webroot','/');
...
$tinybrowser['imageresize']['width']  = 600;
